        ...
        <header class="bg-slack-purple sticky top-0 text-white body-font justify-between flex">
            ...
            <div className='flex-col mx-4 my-2'>
                <nav className="md:ml-auto flex flex-wrap items-center text-base justify-center">
                    <a href='/functionalities' className="px-4 py-2 mr-3 hover:text-purple-400">{data.navigationBar.functionalities.charAt(0).toUpperCase() + data.navigationBar.functionalities.slice(1)}</a>
                    <a href='/solutions' className="px-4 py-2 mr-3 hover:text-purple-400">{data.navigationBar.solutions.charAt(0).toUpperCase() + data.navigationBar.solutions.slice(1)}</a>
                    <a href='/company' className="px-4 py-2 mr-3 hover:text-purple-400">{data.navigationBar.company.charAt(0).toUpperCase() + data.navigationBar.company.slice(1)}</a>
                    <a href='/resources' className="px-4 py-2 mr-3 hover:text-purple-400">{data.navigationBar.resources.charAt(0).toUpperCase() + data.navigationBar.resources.slice(1)}</a>
                    <a href='/prices' className="px-4 py-2 mr-3 hover:text-purple-400">{data.navigationBar.prices.charAt(0).toUpperCase() + data.navigationBar.prices.slice(1)}</a>
                </nav>
            </div>
