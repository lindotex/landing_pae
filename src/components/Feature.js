                ...
                <div class="container px-5 py-4 mx-auto flex flex-wrap">
                    <div class="lg:w-1/2 w-full mb-10 lg:mb-0 rounded-lg overflow-hidden">
                        ...
                        <div className='w-full flex md:flex-row flex-col justify-between items-center mt-4'>
                            ...
                            <button className='md:mt-0 mt-2 flex-col bg-blue-600 text-white border-2 w-full border-blue-600 items-center py-4 rounded-md hover:bg-slack-gold hover:border-slack-gold hover:text-slack-purple'>ENTRAR COM O GOOGLE</button>
                        </div>
